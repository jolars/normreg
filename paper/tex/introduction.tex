...
regularization paths for the lasso\footnote{The estimated coefficients of the lasso as the
  ...
  low value.} for four datasets and two types of normalization. In the figure, we have
colored the lines corresponding to features that were among the first five to enter the
model in either of the two type of normalization schemes. Note that the choice of
normalization result in different sets of features being selected as well as different
...
\begin{figure}[bpt]
  ...
  \caption{%
    ...
    for more information about these datasets.) For each
