...
% TODO: describe these data sets better wrt class balances etc. Perhaps put it 
% in the appendix
...
% TODO: this should probably be part of the theoretical section instead
\begin{enumerate}
...
% TODO: work out theoretically why s3 is working so well
...
We conduct an experiment with the same setup as in \Cref{sec:experiments-mixed-data}, but
...
\Cref{sec:binary-weighting}. Our results (\Cref{fig:mixed-data-elnet}) show that \(\omega =
