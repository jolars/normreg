...
In this section, we focus on the weighted elastic net, which, can be used as an alternative
...
q_j^2)^{\omega}\), as we suggested in \Cref{sec:binary-weighting}. Our results
