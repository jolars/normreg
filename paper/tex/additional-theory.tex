...
In \Cref{fig:binary-onedim-bias-var-elnet}~(\Cref{sec:additional-theory-weighted-elnet}),
...
bias--variance trade-off with respect to \(\omega\). As in \Cref{sec:mixed-data}, we modify
