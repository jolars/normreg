...
(See \Cref{sec:elastic-net-estimator} for a derivation of this.) The assumption of
orthogonal features may seem strong and is indeed almost never realised in practice. For
our results, however, the assumption turns out to have little impact. We refer the reader
to \Cref{sec:orthogonality-assumption}, where we discuss this in detail.
