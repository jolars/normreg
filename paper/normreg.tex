...
Some authors use \emph{standardization} to refer to this procedure, but in this paper we will use standardization only for the case in \Cref{ex:standardization}.
...
% TODO: Perhaps we can just ignore translation altogether and only consider scaling, since translation doesn't actually affect the solution?
