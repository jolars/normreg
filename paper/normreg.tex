...
\begin{equation}
  \label{eq:bias}
  \E \hat\beta_j - \beta_j^*  = \E \frac{1}{d} = \frac{1}{d}\E \st_\lambda(Z) - \beta^*_j = \frac{1}{d}\E \st_{\lambda}(Z) - \beta^*_j.
\end{equation}

The mean-squared error of soft-thresholding of a random variable \(Z\) with mean \(\mu\) is\todojl{Not sure if this is interesting at all.}
\[
...
% TODO: Compute variance here instead?
