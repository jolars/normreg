...
If the features of the normalized design matrix are orthogonal, that is, \(\tilde{\mat{X}} = \diag\left(\tilde{\vec{x}}_1, \dots, \tilde{\vec{x}}_p\right) \), then \Cref{eq:kkt-elasticnet} can be decomposed into a set of \(p + 1\) conditions:
\[
  \begin{cases}
...
\begin{theorem}
  ...
  If \(\vec{x}\) is a binary feature with class balance \(q \in (0, 1)\), \(\alpha = 1\), \(\lambda \in \mathbb{R}^+\), \(\sigma_\varepsilon > 0\), and \(s = (q - q^2)^{\delta}\), \(\delta \geq 0\)  then
  \[
  ...
  \[
    \begin{aligned}
      f'(q) & = \left(\frac{-a(1-2q)}{2\sqrt{q(1-q)}} - b(\delta - 1/2)(1-2q)(q - q^2)^{\delta - 3/2}\right)\pdf\left(\frac{\theta}{\sigma}\right)        \\
            & \qquad - \left(\frac{a(1-2q)}{2\sqrt{q(1-q)}} - b(\delta - 1/2)(1-2q)(q - q^2)^{\delta - 3/2}\right)\pdf\left(\frac{\gamma}{\sigma}\right), \\
