...
\begin{align}
  ...
  \E \st_\lambda(Z) - \mu & = \int_{-\infty}^\frac{-\lambda -\mu}{\sigma} (\sigma u + \lambda + \mu) \pdf(u) \du u + \int_\frac{\lambda - \mu}{\sigma}^\infty (\sigma u - \lambda + \mu) \pdf(u) \du u - \mu \\
                          & = (\lambda + \mu) \cdf\left(\frac{-\lambda-\mu}{\sigma}\right) - \sigma \pdf\left(\frac{-\lambda-\mu}{\sigma}\right)                                                             \\
                          & \phantom{=} + (\mu - \lambda) \cdf\left(\frac{\mu - \lambda}{\sigma}\right) + \sigma \pdf\left(\frac{\mu-\lambda}{\sigma}\right) - \mu.
\end{align}
